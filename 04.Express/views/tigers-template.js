module.exports = {
    home : function(trs) {
        ...
        <body style="margin:50px">
            <img src="/tigers/emblem.jpg" alt="로고" style = "height: 250px;">
    ...
    trsGen: function(rows) {
        ...
        for (let row of rows) {
            trs += '<tr>';
            trs += `<td>${row.id}</td><td>${row.player}</td><td><img src="/tigers/${row.player}.jpg"></td><td>${row.backNo}</td><td>${row.position}</td>`;
